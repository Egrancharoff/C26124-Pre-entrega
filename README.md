...
1. Introduccion > Breve texto que explica el sistema.
2. Listado de vehiculos > Separado en cards para acceder a otras paginas que den el listado de vehiculos ordenados segun el tipo de equipo.
